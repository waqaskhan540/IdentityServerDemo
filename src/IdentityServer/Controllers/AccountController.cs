using AspIdentityClient.Controllers;
...
namespace AspIdentityClient.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        private async Task<AspIdentityClient.Models.LoginViewModel> BuildLoginViewModelAsync(string returnUrl, AuthorizationRequest context)
        {
            ...
            return new AspIdentityClient.Models.LoginViewModel
            {
        ...
        private async Task<AspIdentityClient.Models.LoginViewModel> BuildLoginViewModelAsync(LoginInputModel model)
        {
